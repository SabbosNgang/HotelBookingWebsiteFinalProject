...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="Home.php">SB HOTEL</a>
            ...
            <form action="">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <a href="javascript: void(0)" class="text-secondary text-declaration-none">Forgot Password?</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="">
                <div class="modal-header">
                    <h5 class="modal-title d-flex align-items-center">
                        <i class="bi bi-person-lines-fill fs-3 me-2"></i> User SignUp
                    </h5>
                    <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <div class="row justify-content-center">
                            <div class="col-md-12 mb-2">
                                ...
                                <a href="javascript: void(0)" class="text-secondary text-declaration-none">Already Sign-up?</a>
                            </div>
                        </div>
